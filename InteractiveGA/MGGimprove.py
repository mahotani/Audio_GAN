...
'''
    MGG＋による次世代の生成
'''
def next_generation_MGG_improve(data, solutions, bias, num_parents, num_children, num_elite_preservation):
    new_generation = []
    while data != []:
...
for num_experiment in range(1, 3501):
    ...
    for num in range(num_execute):
        ...
        data = next_generation_MGG_improve(data, solutions, bias, num_parents, num_children, num_elite_preservation)
